...
import javax.swing.*;
import java.awt.*;
public class Marine extends JLabel implements UnitInterface
{
    Image Marine;
    ...
    public Marine(JLabel SpawnArea)
    {
        if (SpawnArea.getName().equals("Player1AreaSpawn"))
            Marine=new ImageIcon("BarracksUnitImages/Battlefield/Player1/Marine.jpg").getImage();
        else
            Marine=new ImageIcon("BarracksUnitImages/Battlefield/Player2/Marine.jpg").getImage();
    ...
    public void paint(Graphics graphic)
    {
        ...
        Icon.drawImage(Marine,x,y,null);
    }
}
