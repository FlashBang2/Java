...
import javax.swing.*;
import java.awt.*;
public class Medic extends JLabel implements UnitInterface
{
    Image Medic;
    ...
    Medic(JLabel SpawnArea)
    {
        if (SpawnArea.getName().equals("Player1AreaSpawn"))
            Medic=new ImageIcon("BarracksUnitImages/Battlefield/Player1/Medic.jpg").getImage();
        else
            Medic=new ImageIcon("BarracksUnitImages/Battlefield/Player2/Medic.jpg").getImage();
